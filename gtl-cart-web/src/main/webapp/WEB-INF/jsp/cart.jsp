...
<div class="w w1 header clearfix">
	<div id="logo"><a href="/"><img clstag="clickcart|keycount|xincart|logo" src="/images/logo.png" title="返回购淘乐商城首页" alt="返回购淘乐商城首页"></a></div>
...
<div class="cart-inner">
    <div class="cart-thead clearfix">
        ...
        <div class="column t-price">购淘乐价</div>
		        ...
		        <div class="item_form clearfix">
		            ...
		            <div class="cell p-quantity" for-stock="for-stock-11345721">
		                <div class="quantity-form" data-bind="">
		                    ...
		                    <input type="text" class="quantity-text" itemPrice="${cart.price/10}" itemId="${cart.id}" value="${cart.num }" id="changeQuantity-11345721-1-1-0">
              ...
              <div class="cart-button">
                  ...
                  <span class="combine-btns" style="display:none">
                      ...
                      <span class="fore2 hide" style="display: inline;">
                          <a href="javascript:goToOverseaOrder();" class="checkout-jdInt">去购淘乐国际结算<b></b></a>
                          <a href="javascript:goToOrder();" class="checkout-jd">去购淘乐结算<b></b></a>
                      </span>
                  </span>
              </div>
              <div class="total fr">
