...
<div id="o-header-2013">
	<div class="w" id="header-2013">
		...
		<%--<div id="my360buy-2013">--%>
			<%--<dl>--%>
				<%--<dt class="ld"><s></s><a href="http://localhost:8084/user/showLogin" clstag="homepage|keycount|home2012|04a">我的购淘乐</a><b></b></dt>--%>
				<%--<dd>--%>
		...
		<div id="nav-2013">
			...
			<div id="treasure" clstag="homepage|keycount|home2013|08a"></div>
				<ul id="navitems-2013">
					...
					<li class="fore2" id="nav-fashion" clstag="homepage|keycount|home2013|07b"><a href="http://localhost:8085/search.html?q=服装">服装城</a></li>
