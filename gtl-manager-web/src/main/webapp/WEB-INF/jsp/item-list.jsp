...
<table class="easyui-datagrid" id="itemList" title="商品列表" 
    ...
    <thead>
        <tr>
            ...
            <th data-options="field:'title',width:400">商品标题</th>
...
<div id="itemSearchWindow" class="easyui-window" title="搜索商品" data-options="modal:true,closed:true,iconCls:'icon-save',href:'/item-search'" style="width:50%;height:50%;padding:10px;">
</div>
<script>
    ...
    var toolbar = [{
        ...
        //     iconCls:'icon-search',
        //     handler:function(){
        //         // alert($.cookie('search_item_cookie'));
