...
<div class="w" id="logo">
    <div>
    	<a href="http://localhost:8082">
    		<img src="/images/logo.png" alt="购淘乐商城" width="170" height="60"/>
    	</a> <b></b>
    </div>
</div>
            ...
            <div class="form" onselectstart="return false;">
                ...
                <div class="item item-new">
                    ...
                    <div class="fl item-ifo">
                        ...
                        <label for="protocol">我已阅读并同意<a href="#" class="blue" id="protocol">《购淘乐用户注册协议》</a></label>
                        <span class="clr"></span>
