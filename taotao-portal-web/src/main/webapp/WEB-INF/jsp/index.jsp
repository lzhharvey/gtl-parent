...
<title>购淘乐网上商城-综合网购首选（JD.COM）-正品低价、品质保障、货到付款、配送及时、放心服务、轻松购物！</title>
<meta name="description" content="购淘乐JD.COM-专业的综合网上购物商城，在线销售家电、数码通讯、电脑、家居百货、服装服饰、母婴、图书、食品、在线旅游等数万个品牌千万种优质商品。便捷、诚信的服务，为您提供愉悦的网上商城购物体验! ">
...
<div class="sm sm2 fore1 curr"  data-widget="tab-item" data-tag="1622" clstag="homepage|keycount|home2013|18d">
	<div class="smt">
    <h3>${ad3.get(0).title}</h3>
  </div>
	<div class="smc" data-widget="tab-content">
		<ul class="lh style3">
		<c:forEach items="${ad3.get(0).tbItems}" var="item"  begin="0" end="9">
		<li class="fore1">
			<div class="p-img ld"><a target="_blank" href="http://item.jd.com/1221882.html" title="预约客户1999抢购中，长虹LED42538ES，42吋窄边电视">
				<img height="100" width="100" alt="预约客户1999抢购中，长虹LED42538ES，42吋窄边电视" data-img="1" src="${item.image.split(",")[0]}"></a></div>
			<div class="p-name">
				<a target="_blank" href="http://item.jd.com/1221882.html" title="预约客户1999抢购中，长虹LED42538ES，42吋窄边电视">${item.title}</a>
			</div>
			<div class="p-price"><span>￥</span>$${item.price}.<span>00</span></div>
		</li>
		</c:forEach>
		</ul>
	</div>
	...
	<div class="sm sm2 fore2 "  data-widget="tab-item" data-tag="1622" clstag="homepage|keycount|home2013|18d">
		<div class="smt" >
			<h3>${ad3.get(1).title}</h3>
		</div>
		<div class="smc" data-widget="tab-content">
			<ul class="lh style3">
				<c:forEach  items="${ad3.get(1).tbItems}" var="item" begin="0" end="9">
					<li class="fore1">
						<div class="p-img ld"><a target="_blank" href="http://item.jd.com/1221882.html" title="预约客户1999抢购中，长虹LED42538ES，42吋窄边电视">
							<img height="100" width="100" alt="预约客户1999抢购中，长虹LED42538ES，42吋窄边电视" data-img="1" src="${item.image.split(",")[0]}"></a></div>
						<div class="p-name">
	...
	<div class="sm sm2 fore3 "  data-widget="tab-item" data-tag="1622" clstag="homepage|keycount|home2013|18d">
		<div class="smt" >
			<h3>${ad3.get(2).title}</h3>
		</div>
		<div class="smc" data-widget="tab-content">
			<ul class="lh style3">
				<c:forEach items="${ad3.get(2).tbItems}" var="item" begin="0" end="9">
					<li class="fore1">
						<div class="p-img ld"><a target="_blank" href="http://item.jd.com/1221882.html" title="预约客户1999抢购中，长虹LED42538ES，42吋窄边电视">
							<img height="100" width="100" alt="预约客户1999抢购中，长虹LED42538ES，42吋窄边电视" data-img="1" src="${item.image.split(",")[0]}"></a></div>
						<div class="p-name">
	...
	<div class="sm sm2 fore4 "  data-widget="tab-item" data-tag="1622" clstag="homepage|keycount|home2013|18d">
		<div class="smt" >
			<h3>${ad3.get(3).title}</h3>
		</div>
		<div class="smc" data-widget="tab-content">
			<ul class="lh style3">
				<c:forEach items="${ad3.get(3).tbItems}" var="item"  begin="0" end="9">
					<li class="fore1">
						<div class="p-img ld"><a target="_blank" href="http://item.jd.com/1221882.html" title="预约客户1999抢购中，长虹LED42538ES，42吋窄边电视">
							<img height="100" width="100" alt="预约客户1999抢购中，长虹LED42538ES，42吋窄边电视" data-img="1" src="${item.image.split(",")[0]}"></a></div>
						<div class="p-name">
